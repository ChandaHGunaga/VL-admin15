      ...
      <div className="dashboard-blocks">
        <div className="dashboard-block1">
          <div className="dashboard-block-text">
            ...
            <div className="dashboard-block-value">{dashboardData && dashboardData.totalStudentsEnrolled && dashboardData.totalStudentsEnrolled}</div>
          </div>
        ...
        <div className="dashboard-block1">
          <div className="dashboard-block-text">
            ...
            <div className="dashboard-block-value">{dashboardData && dashboardData.overallResult && dashboardData.overallResult}%</div>
          </div>
          <div className="dashboard-block-img">
            <svg
              width={77}
        ...
        <div className="dashboard-block1">
          <div className="dashboard-block-text">
            ...
            <div className="dashboard-block-value">{dashboardData && dashboardData.totalCoursesAdded
